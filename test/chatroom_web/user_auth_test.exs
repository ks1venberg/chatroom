defmodule ChatroomWeb.UserAuthTest do
  use ChatroomWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Chatroom.Accounts
  alias ChatroomWeb.UserAuth
  import Chatroom.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ChatroomWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ChatroomWeb.Endpoint.subscribe(live_socket_id)
